...
void test_orientation()
{
    ...
    x3.setSPH(0.0, 1.0/Rad2Deg);

    x1.setSPH(355.0/Rad2Deg, 0.0);
    x2.setSPH(5.0/Rad2Deg, 0.0);
    
    orient = Sphere::orient(x1, x2, x3);

    assert(orient == OrientLeft);

    x1.setSPH(185.0/Rad2Deg, 0.0);
    x2.setSPH(175.0/Rad2Deg, 0.0);
...
void test_intersection()
{
    ...
    x1.setSPH(1.2280734796218382154, 0.66012992695828620615);
    x2.setSPH(1.2458688154227666178, 0.66312169804405485252);
    lon1 = 1.2348204457859882;
    lon2 = 1.2435470920459597;
    lat = 0.66138792707153526;
#endif
#ifdef INTERSECTION_FAILURE_2
    x1.setSPH(5.9189382174881215448, -0.56333636933501674005);
    x2.setSPH(5.9881996873649860902, -0.4759259931534789434);
